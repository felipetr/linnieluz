...
function register_custom_post_types()
{
    ...
    register_post_type('area_de_atuacao', array(
        ...
        'has_archive' => true,
        'supports' => array('title', 'editor'),
        'menu_icon' => 'dashicons-businessman', // Ícone alterado para Businessman
    ));
}
...
?>
    ...
    <div class="metabox-content">
        <div class="form-field form-required">
            ...
            <input type="email" id="email" class="widefat" placeholder="Preencha o Email" name="email" value="<?php echo esc_attr($email); ?>" required>
        </div>
        <style>
            .metabox-content {
                display: flex;
        ...
        <div class="form-field form-required">
            ...
            <input type="text" id="telefone" class="widefat" name="telefone" value="<?php echo esc_attr($telefone); ?>" required>
        </div>
    </div>
    <hr style="margin-top: 15px">
    <label for="latitude"><h3>Localização:</h3></label>
    <input type="hidden" id="latitude" name="latitude" value="<?php if ($latitude) {
    ...
    <input type="hidden" id="longitude" name="longitude" value="<?php if ($longitude) {
...
function area_meta_callback($post)
{
    ...
    ?>
        ...
        <input type="text" id="icone" name="icone" value="<?php echo esc_attr($icone); ?>" required>
    <?php
}
...
function contato_meta_callback($post)
{
    ...
    ?>
        ...
        <input type="text" id="contato_telefone" name="contato_telefone" value="<?php echo esc_attr($telefone); ?>" required>
            ...
            <?php if (!empty($redes_sociais)) {
                foreach ($redes_sociais as $rede) { ?>
                    <div class="rede-social">
                        ...
                        <input type="text" name="rede_link[]" value="<?php echo esc_attr($rede['link']); ?>" placeholder="Link" required>
...
function youtube_channel_meta_callback($post)
{
    ...
    ?>
        ...
        <input type="text" id="youtube_channel_id" name="youtube_channel_id" value="<?php echo esc_attr($channel_id); ?>">
    <?php
}

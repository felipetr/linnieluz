...
?>
    ...
    <script type="text/javascript">
        const iconsData = <?php echo json_encode($icons_data['icons']); ?>;
    </script>
    <div class="icon-module">
        <div class="icon-box">
            <div class="iconshow">
                <i
                    class="<?php
                                    echo !empty($inputvalue)
                                        ? $inputvalue
                                        : 'lni lni-question-mark';
                                    ?>"></i>
            </div>
            <button type="button" class="changeicon">
                <span><?php echo !empty($inputvalue)
                            ? 'Alterar'
                            : 'Adicionar'; ?> Ícone</span><i class="lni lni-chevron-down"></i></button>
        </div>
                                        ...
                                        $keywords = preg_replace(
                                            ...
                                            strtolower(
                                                iconv(
                                                    'UTF-8',
                                                    'ASCII//TRANSLIT',
                                                   str_replace('-',' ', $icon['name']) . ' ' . $icon['keywords']
                                                )
                                            )
                                        );
                                        echo trim($keywords);
